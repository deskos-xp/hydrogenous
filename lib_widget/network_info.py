...
class Ui_network_info(object):
    def setupUi(self, network_info):
        ...
        network_info.resize(612, 336)
        self.gridLayout_2 = QtWidgets.QGridLayout(network_info)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.nic = QtWidgets.QGroupBox(network_info)
        self.nic.setObjectName("nic")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.nic)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.frame_3 = QtWidgets.QFrame(self.nic)
        ...
        self.gridLayout.addWidget(self.nic, 0, 0, 1, 1)
    ...
    def retranslateUi(self, network_info):
        ...
        self.nic.setTitle(_translate("network_info", "Nic"))
        ...
        item.setText(_translate("network_info", "netmask"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("network_info", "broadcast"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("network_info", "ptp"))
